...
- Special Acknowledgement to ChatGPT for helping me find ways to fix the the huge amount off API issues that affects many off my codes. some doesnt run anymore :')
